        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-white/95 backdrop-blur-xl rounded-xl shadow-xl border border-slate-200 overflow-hidden">
                  <div className="py-1">
                    <Link
                      to="/profile"
                    ...
                    <Link
                      to="/logout"
                      onClick={() => setIsUserMenuOpen(false)}
                      className="flex items-center gap-3 px-3 py-2.5 hover:bg-red-50 text-sm text-red-600"
                    >
