...
const VocabularyTopicModal = ({ isOpen, onClose, mainTopic }) => {
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200"
                  />
                </div>
              </div>
            )}
              ...
              <div className="text-center py-12">
                ...
                {searchTerm && (
                  <button
                    ...
                    className="mt-2 text-slate-600 hover:text-slate-700 text-sm"
                  >
                    Xóa tìm kiếm
                  </button>
                )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-96 overflow-y-auto">
                {filteredSubTopics.map((subTopic, index) => {
                  ...
                  return (
                    <Link
                      key={subTopic}
                      to={`/vocabulary/tests/${encodeURIComponent(mainTopic)}/${encodeURIComponent(subTopic)}`}
                      onClick={onClose}
                      className={`
...
export default VocabularyTopicModal;